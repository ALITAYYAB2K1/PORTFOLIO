...
export const getAllApplications = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      "http://localhost:8000/api/v1/softwareapplications/getall",
      {
...
export const addApplication = (applicationData) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      "http://localhost:8000/api/v1/softwareapplications/add",
      applicationData,
      {
        withCredentials: true,
        headers: {
...
export const deleteApplication = (id) => async (dispatch) => {
  ...
  try {
    // FIXED URL to match your Express route registration
    await axios.delete(
      `http://localhost:8000/api/v1/softwareapplications/delete/${id}`,
      {
        withCredentials: true,
      }
    );
